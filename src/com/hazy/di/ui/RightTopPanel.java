...
public class RightTopPanel implements IRightTopPanel {
	...
	public void showData(ITaskMan task) {
		...
		input.setText(task.getInputfilepath());
		output.setText(task.getOutputfilepath());
	}
