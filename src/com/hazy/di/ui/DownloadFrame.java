...
public class DownloadFrame implements IFrame{

	static Logger logger = Logger.getLogger(DownloadFrame.class);
	private JFrame frame = new JFrame("文档下载");
	
	private JPanel rightPanel = new JPanel();
	
	private TopPanel topPanel;
	
	private InputPanel rtp=new InputPanel();
	...
	//	JSplitPane splitPane1 = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, false, jScrollPane1,splitPaneRight);
		...
		contentPane.add(splitPaneRight,BorderLayout.CENTER);
